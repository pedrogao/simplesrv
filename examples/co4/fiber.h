#ifndef NEBULA_FIBER_H_
#define NEBULA_FIBER_H_
...
extern "C"
{
  ...
  */
  ...
  typedef long (*ef_fiber_proc_t)(void *param); // 协程执行函数
...
#define ef_fiber_is_exited(fiber) ((fiber)->status == FIBER_STATUS_EXITED)
   ...
   * https://zh.m.wikipedia.org/zh-hans/SIGSEGV sigsegv 用于处理 segment fault
   */
